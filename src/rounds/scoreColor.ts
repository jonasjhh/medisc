export type ScoreOutcome =
  "ace" | "eagle" | "birdie" | "par" | "bogey" | "doubleBogey" | "worse";
...
// 2+ under is an eagle, 1 under a birdie, 1/2 over a bogey/double bogey,
// and 3+ over is lumped into "worse" (triple bogey or beyond).
